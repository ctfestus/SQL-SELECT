          ...
          <div className="p-4 space-y-2">
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all ${
                activeTab === 'learners' ? 'bg-corp-cyan text-corp-dark shadow-lg shadow-corp-cyan/20' : 'text-slate-400 hover:bg-white/5 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all ${
                activeTab === 'courses' ? 'bg-corp-cyan text-corp-dark shadow-lg shadow-corp-cyan/20' : 'text-slate-400 hover:bg-white/5 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all ${
                activeTab === 'bundles' ? 'bg-corp-cyan text-corp-dark shadow-lg shadow-corp-cyan/20' : 'text-slate-400 hover:bg-white/5 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all ${
                activeTab === 'subscriptions' ? 'bg-corp-cyan text-corp-dark shadow-lg shadow-corp-cyan/20' : 'text-slate-400 hover:bg-white/5 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all ${
                activeTab === 'access' ? 'bg-corp-cyan text-corp-dark shadow-lg shadow-corp-cyan/20' : 'text-slate-400 hover:bg-white/5 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all ${
                activeTab === 'content' ? 'bg-corp-cyan text-corp-dark shadow-lg shadow-corp-cyan/20' : 'text-slate-400 hover:bg-white/5 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm transition-all ${
                activeTab === 'create' ? 'bg-corp-cyan text-corp-dark shadow-lg shadow-corp-cyan/20' : 'text-slate-400 hover:bg-white/5 hover:text-white'
              }`}
            >
                              ...
                              <div className="p-6 border-b border-white/5 bg-black/20">
                                  <h3 className="text-xl font-bold text-white capitalize flex items-center justify-between">
                                      ...
                                      <span className={`text-[10px] px-2 py-1 rounded font-bold uppercase tracking-wider ${
                                          perm.tier === 'pro' ? 'bg-orange-500/10 text-orange-400 border border-orange-500/20' : 
                                              ...
                                              >
                                                  <div className="flex items-center gap-4">
                                                      <div className={`w-6 h-6 rounded-full border flex items-center justify-center transition-colors ${
                                                          isSelected ? 'bg-corp-cyan border-corp-cyan text-corp-dark' : 'border-slate-500 text-transparent group-hover:border-slate-400'
                                                      }`}>
                                                          <Check size={14} />
                                                      </div>
                                                      <div>
                    ...
                    {loading ? (
                      ...
                      <tr key={learner.id} className="hover:bg-gradient-to-r from-white/5 to-transparent transition-colors group">
                        ...
                        <td className="px-6 py-5">
                          <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-wide border ${
                            learner.subscription_plan?.includes('pro') ? 'bg-corp-orange/10 text-corp-orange border-corp-orange/20' : 
